...
Browser access: `http://csb-u70984.vm.elestio.app:8080` (HTTP; passcode-gated). For a shared HTTPS link, front port 8080 with Elestio's reverse proxy (`docs/elestio.md` §B).
